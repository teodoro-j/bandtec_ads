...
public class TesteFilme<fim> {
    ...
    public static void gravaFilmePorGenero(ListaObj<Filme> lista, String genero) {
        ...
        Formatter saida = null;
        boolean deuRuim = false;
        String nomeArquivo = "filmegenero.csv";
    ...
    public static void main(String[] args) {
        ...
        int idade;
        boolean fim = false;
        ListaObj<Filme> lista = new ListaObj(8);
        ...
        while (!fim) {
            ...
            switch (opcao) {
                ...
                case 6:
                    leExibeArquivo("filmegenero.csv");
                    break;
